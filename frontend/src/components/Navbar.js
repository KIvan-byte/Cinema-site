...
const Navbar = () => {
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-cinema-red-dark shadow-md' : 'bg-gradient-to-r from-cinema-red-dark to-cinema-black'}`}>
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link to="/" className="flex items-center">
            <span className="bg-white text-cinema-red-dark px-2 py-1 rounded font-bold text-xl mr-1">CINEMA</span>
